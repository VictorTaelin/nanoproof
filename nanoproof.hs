...
show_term lvl term = case term of
  ...
  All dom cod -> "@" ++ show_grouped lvl dom ++ "." ++ show_term lvl cod
  Sig dom cod -> "&" ++ show_grouped lvl dom ++ "." ++ show_term lvl cod
  Eql lft rgt -> show_grouped lvl lft ++ " == " ++ show_grouped lvl rgt
  One -> "()"
  Boo False -> "0"
  Boo True -> "1"
